...
<ul>
	<li>A tiny JS framework (think <a href="https://mithril.js.org/" target="_blank" rel="noreferrer">Mithril.js</a>)</li>
	<li>A utility library like <a href="https://lodash.com/" target="_blank" rel="noreferrer">lodash</a> or <a href="https://jquery.com/" target="_blank" rel="noreferrer">jQuery</a></li>
	<li>Something for easily enhancing your HTML with scripting, like <a href="https://alpinejs.dev/" target="_blank" rel="noreferrer">Alpine.js</a></li>
	<li>A reactivity system to automatically update your HTML from data</li>
</ul>

<p>
	See the <a href="/guide">Guide</a>, showing how to build an example project, more inspiration!
</p>
